    ...
    return(
        <main className="pb-72 items-center text-white ">
            <div className="flex justify-center items-center gap-8">
                <div className="grid grid-cols-10 gap-5 w-[1300px]">
                    <div className="flex-col gap-7 col-span-6 h-[250px] rounded-4xl bg-gradient-to-r from-orange-200 via-orange-100 to-orange-100  justify-start items-start flex text-black text-2xl pt-8 px-10">
                        <p className="w-[600px] text-left text-[21px] leading-8">
                    ...
                    <div className="flex items-center justify-center col-span-4 h-[240px] bg-[#B9D9D9] rounded-4xl ">

                    </div>

                    <div className="col-span-4 h-[240px] rounded-4xl justify-center items-center flex">
                    ...
                    <div className="flex flex-col gap-5 col-span-2">
                        ...
                        <div className="col-span-2 h-[110px] bg-[#B9D9D9] rounded-4xl justify-center items-center flex gap-4 text-2xl font-black text-black">
                            <span className="text-5xl">1</span>
                            <span className="text-[22px] ml-1">year exp.</span>
                        </div>
                    </div>
                    <div className="col-span-4 h-[240px] bg-[#141414ec] rounded-4xl justify-between items-start flex p-10">
